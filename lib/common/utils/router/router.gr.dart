...
class SignUpCreateRoute extends _i9.PageRouteInfo<void> {
  const SignUpCreateRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class SignUpGenderRoute extends _i9.PageRouteInfo<void> {
  const SignUpGenderRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class SignUpNameRoute extends _i9.PageRouteInfo<void> {
  const SignUpNameRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class SignUpPhoneRoute extends _i9.PageRouteInfo<void> {
  const SignUpPhoneRoute({List<_i9.PageRouteInfo>? children})
      : super(
