...
class NotificationProfilePreview
  ...
  static _i36.PageInfo page = _i36.PageInfo(
    ...
    builder: (data) {
      ...
      return _i14.NotificationProfilePreview(
        key: args.key,
        id: args.id,
      );
    },
...
class ResetSuccessRoute extends _i36.PageRouteInfo<ResetSuccessRouteArgs> {
  ...
  static _i36.PageInfo page = _i36.PageInfo(
    ...
    builder: (data) {
      ...
      return _i22.ResetSuccessScreen(
        key: args.key,
        email: args.email,
      );
    },
...
class SignUpVerificationRoute
  ...
  static _i36.PageInfo page = _i36.PageInfo(
    ...
    builder: (data) {
      ...
      return _i29.SignUpVerificationScreen(
        key: args.key,
        pop: args.pop,
      );
    },
