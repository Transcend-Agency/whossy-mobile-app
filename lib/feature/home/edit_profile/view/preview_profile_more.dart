...
class PreviewProfileMore extends StatefulWidget {
  const PreviewProfileMore({super.key});
                        ...
                        child: Stack(
                          children: [
                            ...
                            const Align(
                              ...
                              child: BottomPreviewImage(showLess: true),
                            ),
                          ],
                        ),
                      ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ProfileDetailsCard(
                      ...
                      content: PreviewInfoColumn(
                        items: [
                          ...
                          InfoItem(
                              label: "Education", value: "Crawford University"),
                        ],
                      ),
                    ),
                    ProfileDetailsCard(
                    ...
                    ProfileDetailsCard(
                      ...
                      content: PreviewInfoColumn(
                        items: [
                          InfoItem(label: "Smoker", value: "Doesn't smoke"),
                          InfoItem(
                              label: "Do you drink", value: "Not my thing"),
                          InfoItem(label: "Workout", value: "Occasionally"),
